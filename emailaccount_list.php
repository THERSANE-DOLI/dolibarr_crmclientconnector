...
/**
 *   	\file       emailaccount_list.php
 *		\ingroup    crmclientconnector
 *		\brief      List page for emailaccount
 */
...
require_once __DIR__.'/class/emailaccount.class.php';
// for other modules
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('crmclientconnector', 'emailaccount', 'write');
	$permissiontodelete = $user->hasRight('crmclientconnector', 'emailaccount', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
$title = $langs->trans("EmailAccounts");
//$help_url = "EN:Module_EmailAccount|FR:Module_EmailAccount_FR|ES:Módulo_EmailAccount";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/crmclientconnector/emailaccount_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/crmclientconnector/emailaccount_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendEmailAccountRef";
$modelmail = "emailaccount";
$objecttmp = new EmailAccount($db);
